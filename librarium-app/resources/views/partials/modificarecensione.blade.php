...
<div class="md:flex justify-center">
    <div class="w-full ">
        ...
        <p class="fs-3 mt-4 text-center custom-text-color">Hai già recensito questo libro!</p>
        <p class="fs-5 text-center custom-text-color">Se vuoi puoi modificare la tua recensione</p>
