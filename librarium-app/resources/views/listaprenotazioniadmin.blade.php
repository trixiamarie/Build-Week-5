            ...
            <div class="bg-white  shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200" style="overflow: scroll; height:40rem;">
                    <table class="table">
                        ...
                        <tbody>
                            @if($bookings->count() > 0)
                            @foreach($bookings->where('state', 'pending') as $index => $booking)
                            <tr>
                ...
                <div class="p-6 bg-white border-b border-gray-200" style="overflow: scroll; height:40rem;">
                    <table class="table">
                        ...
                        <tbody>
                            @if($bookings->count() > 0)
                            @foreach($bookings->where('state', 'accettato') as $index => $booking)
                            <tr>
                                <th scope="row">{{$booking->id}}</th>
                                <td>
                                    <div class="book-details d-flex align-items-center">
                ...
                <div class="p-6 bg-white border-b border-gray-200" style="overflow: scroll; height:40rem;">
                    <table class="table">
                        ...
                        <tbody>
                            @if($bookings->count() > 0)
                            @foreach($bookings->where('state', 'negato') as $index => $booking)
                            <tr>
                                <th scope="row">{{$booking->id}}</th>
                                <td>
                                    <div class="book-details d-flex align-items-center">
